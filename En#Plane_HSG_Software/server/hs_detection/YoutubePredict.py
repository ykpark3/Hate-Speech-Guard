...
#BASE_DIR = os.getcwd()
#print(BASE_DIR)
#M_IDR = os.path.join(BASE_DIR, "model_cnn_1.h5")
#"C:/Users/mo_ah/Desktop/ReactStudy/web/hs_detection/model_cnn_1.h5"
model = load_model('./hs_detection/model_cnn_1.h5')
    ...
    if 'en' in list_manually_generated_caption or 'en' in list_auto_generated_caption:
        ...
        for i in range(len(data)):
            ...
            if(category_sentence == 0) :
                ...
                print(str(data[i]['start']) +'~' + str(end))
