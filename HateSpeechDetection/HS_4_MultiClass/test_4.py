...
category_class = ['obscene','offensive','racism','sexism']
...
with open('csv4/hs_total_data_cleanded.pickle', 'rb') as handle:
    token = pickle.load(handle)

text = data_text_cleaning("i dont like gay such like you disgusting")
...
explanation = explainer.explain_instance(text, predict_result,labels=(0,1,2,3))
